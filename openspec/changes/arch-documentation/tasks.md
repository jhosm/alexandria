...
- [ ] 4.3 Add test in `src/server/__tests__/server.test.ts`: seed an "arch" entry with doc chunks, call `search-arch-docs`, verify results scoped to arch; verify error when arch not indexed
